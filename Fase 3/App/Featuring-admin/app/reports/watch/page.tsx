  ...
  const handleExpandReporte = async (reporteId: string) => {
    ...
    if (reporte.tipo_contenido === 'video') {
      try {
        ...
        // Establecer contentDetails incluso si el video no existe
        setContentDetails(data || {
          id: parseInt(reporte.contenido_id || '0'),
          titulo: '[Video eliminado]',
          descripcion: 'Este video ha sido eliminado por un administrador.',
          thumbnail: '',
          url: '',
        ...
        setContentDetails({
          id: parseInt(reporte.contenido_id || '0'),
          titulo: '[Error al cargar el video]',
          descripcion: 'No se pudo cargar la información del video.',
          thumbnail: '',
          url: '',
          usuario_id: reporte.usuario_reportado_id
        });
                ...
                <div className="flex-1 overflow-y-auto">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    {contentDetails && (
                      <div className="space-y-4">
                        <div className="bg-gray-50 p-4 rounded-lg">
                          <h4 className="font-semibold text-lg mb-2">Video Reportado</h4>
                          {contentDetails.url ? (
                            <video 
                              controls 
                            ...
                            <div className="flex flex-col items-center justify-center p-8 bg-gray-100 rounded-lg">
                              ...
                              <h5 className="text-lg font-medium text-gray-900 mb-2">Video Eliminado</h5>
                              <p className="text-gray-500 text-center">Este video ha sido eliminado del sistema</p>
                            </div>
                          )}
                          <p className="mt-2 text-sm text-gray-500">Descripción: {contentDetails.descripcion}</p>
                        </div>
                      </div>
                    )}
                  </div>
