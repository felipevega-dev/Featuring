  ...
  const handleExpandReporte = async (reporteId: string) => {
    ...
    if (reporte.tipo_contenido === 'video') {
      try {
        ...
        console.log('Datos del video obtenidos:', data);

        if (data) {
          // Usar directamente la URL del video sin modificaciones
  ...
  return (
    <div className="container mx-auto px-2 py-4 sm:px-4 sm:py-8">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-4 sm:mb-8">
        <h1 className="text-xl sm:text-4xl font-bold text-primary-700 mb-2 sm:mb-0">Reportes de Watch</h1>
